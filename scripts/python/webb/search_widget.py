...
class WebSearcherWidget(QtWidgets.QWidget):
    def __init__(self, parent, platform: SearchPlatform = Google):
        super(WebSearcherWidget, self).__init__(
            parent
        )
    ...
    def layouts(self)->None:
        ...
        self.container.addWidget(self.searchInput)
